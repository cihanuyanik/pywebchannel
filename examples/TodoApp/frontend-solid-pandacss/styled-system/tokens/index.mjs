const tokens = {
  ...
  "colors.primaryDarker": {
    "value": "#260548",
    "variable": "var(--colors-primary-darker)"
  },
  "colors.secondary": {
    "value": "#0c0979",
  ...
  "colors.secondaryLighter": {
    "value": "#534ef2",
    "variable": "var(--colors-secondary-lighter)"
  },
  "colors.secondaryDarker": {
    "value": "#06043c",
    "variable": "var(--colors-secondary-darker)"
  },
  "colors.tertiary": {
    "value": "#4e8fcd",
    "variable": "var(--colors-tertiary)"
  },
  "colors.tertiaryLighter": {
    "value": "#a6c7e6",
    "variable": "var(--colors-tertiary-lighter)"
  },
  "colors.tertiaryDarker": {
    "value": "#1f486e",
    "variable": "var(--colors-tertiary-darker)"
  },
  "colors.text": {
    "value": "#ffffff",
